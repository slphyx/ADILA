    ...
    sidebarMenu(
      ...
      menuItem("Type of patients", tabName = "type_patients", icon = icon("user"),
               div(id = "type_patients_inputs",
                  ...
                  column(6,
                   ...
                   numericInput("bm_cases", tags$h6("Patients with bacterial meningitis"), min = 0, max = 10000, value = 15,width ="100%"),
                   numericInput("bji_cases", tags$h6("Patients with bone and joint infection (acute bacterial osteomyelitis and septic arthritis)"), min = 0, max = 10000, value = 30,width ="100%"),
                   numericInput("uut_cases",tags$h6("Patients with upper urinary tract infection"), min = 0, max = 10000, value = 35,width ="100%"),
                   numericInput("sepsis_cases", tags$h6("Patients with sepsis & septic shock"), min = 0, max = 10000, value = 10,width ="100%"),
                   numericInput("cdif_cases", tags$h6("Patients with Clostridioides difficile infection"), min = 0, max = 10000, value = 30,width ="100%"),
                   ),
                   column(6,
                   ...
                   numericInput("sst_cases", tags$h6("Patients with skin and soft-tissue infection (necrotizing fasciitis and pyomyositis)"), min = 0, max = 10000, value = 30,width ="100%"),
                   numericInput("fn_cases", tags$h6("Patients with febrile neutropenic"), min = 0, max = 10000, value = 30,width ="100%"),
      ...
      menuItem("Severity of cases", tabName = "severity_cases", icon = icon("exclamation-triangle"),
               div(id = "severity_cases_inputs",
                   sliderInput("cap_severe", tags$h6("Proportion of severe CAP cases"), min = 0, max = 1, value = 0.4, step = 0.01),
                   sliderInput("abd_severe", tags$h6("Proportion of severe intra-abdominal infection cases"), min = 0, max = 1, value = 0.45, step = 0.01),
                   sliderInput("uti_severe", tags$h6("Proportion of severe upper UTI cases"), min = 0, max = 1, value = 0.35, step = 0.01),
                   sliderInput("cdf_severe", tags$h6("Proportion of severe C. difficile infection cases"), min = 0, max = 1, value = 0.25, step = 0.01),
                   sliderInput("sst_nf", tags$h6("Proportion of necrotizing fasciitis cases in SST patients"), min = 0, max = 1, value = 0.04, step = 0.01)
               )
      ...
      menuItem("Availability of first choice antibiotics", tabName = "availability_antibiotics", icon = icon("capsules"),
               div(id = "availability_antibiotics_inputs",
                   sliderInput("p_first", tags$h6("Probability of first-choice antibiotics"), min = 0, max = 1, value = 0.8, step = 0.01)
               )           
      ),
      ...
      menuItem("Prevalence of AMR", tabName = "prevalence_amr", icon = icon("chart-line"),
               div(id = "prevalence_amr_inputs",
                   sliderInput("esbl_prevalence", tags$h6("Prevalence of ESBL"), min = 0, max = 1, value = 0.4, step = 0.01),
                   sliderInput("mrsa_prevalence", tags$h6("Prevalence of MRSA"), min = 0, max = 1, value = 0.3, step = 0.01),
                   sliderInput("hap_mdr", tags$h6("Prevalence of multi-drug resistance gram-negative infection in patients with hospital acquired pneumonia"), min = 0, max = 1, value = 0.1, step = 0.01),
                   sliderInput("strep_pyogenes", tags$h6("Prevalence of Strep pyogenes infection in necrotizing fasciitis"), min = 0, max = 1, value = 0.1, step = 0.01)
               )         
      ),
      
      # Sidebar item for "Total Admitted Patients"
      menuItem("Total admitted patients", tabName = tags$h6("total_patients"), icon = icon("hospital"),
